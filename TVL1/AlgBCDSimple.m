...
tol = 1e-6; % tol = tolerance of errors
...
for i=1:maxiter    
 ...
 q22temp=(q22-q22_old)/2;
    q11=mu*Proj((q11h-L11TL12*q12temp-L11TL21*q21temp-L11TL22*q22temp)/mu);
 q11temp=(q11-q11_old)/2;
    q12=mu*Proj((q12h-L12TL11*q11temp-L12TL21*q21temp-L12TL22*q22temp)/mu);
 q12temp=(q12-q12_old)/2;
    q21=mu*Proj((q21h-L21TL11*q11temp-L21TL12*q12temp-L21TL22*q22temp)/mu);
 q21temp=(q21-q21_old)/2;
    q22=mu*Proj((q22h-L22TL11*q11temp-L22TL12*q12temp-L22TL21*q21temp)/mu);
